...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TeleportAppV3Status) DeepCopyInto(out *TeleportAppV3Status) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TeleportAppV3Status.
func (in *TeleportAppV3Status) DeepCopy() *TeleportAppV3Status {
	if in == nil {
		return nil
	}
	out := new(TeleportAppV3Status)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TeleportDatabaseV3Status) DeepCopyInto(out *TeleportDatabaseV3Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]metav1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TeleportDatabaseV3Status.
func (in *TeleportDatabaseV3Status) DeepCopy() *TeleportDatabaseV3Status {
	if in == nil {
		return nil
	}
	out := new(TeleportDatabaseV3Status)
	in.DeepCopyInto(out)
	return out
}
